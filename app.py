...
def login():
    ...
    if user == "Gobu" and code == "1234":
        ...
        messagebox.showerror("Invalid", "You need to enter the password to login")
    elif user != "Gobu" and code != "1234":
        messagebox.showerror("Invalid", "Please enter username and password")
    elif user != "Gobu":
...
def main_screen():
    ...
    global password
    screen = Tk()
    screen.geometry("1280x700+150+80")
    screen.configure(bg="#d7dae2")

    #icon
    image_icon = PhotoImage(file="resources/login.png")
